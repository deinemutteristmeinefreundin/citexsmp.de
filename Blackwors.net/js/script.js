...
const config = {
    serverInfo: {
        ...
        serverName: "Citex Network", /*Server name*/
        serverIp: "mc.citexsmp.de", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1364688227163701309" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "star_HD",  <--- In-Game name
            rank: "Owner",  <-- rank
    ...
    */
    ...
    adminTeamPage: {
		...
		Vips: [
            {
                inGameName: "?Kaufe dir ein Rank um hier zu stehen?",
                rank: "Titan",
                skinUrlOrPathToFile: "",
                rankColor: ""
            }
    ...
    */
    contactPage: {
        email: "HatcherGames.info@web.de"
    }
}
